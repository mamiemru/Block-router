...
public class ScatterScreen extends AbstractContainerScreen<ScatterMenu> {

    protected int imageWidth = 200;
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(BlocRouter.MOD_ID,"textures/gui/block_scatter_gui.png");
    ...
    private void assignEnergyInfoArea() {
        ...
        energyInfoArea = new EnergyInfoArea(x + 171, y + 9,  ((ScatterEntity)menu.getEntity()).getEnergyStorage());
    }
