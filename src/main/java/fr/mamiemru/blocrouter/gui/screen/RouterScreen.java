...
public class RouterScreen extends AbstractContainerScreen<RouterMenu> {
    ...
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(BlocRouter.MOD_ID,"textures/gui/block_router_gui.png");
    ...
    private void assignEnergyInfoArea() {
        ...
        energyInfoArea = new EnergyInfoArea(x + 171, y + 9,  ((RouterEntity)menu.getEntity()).getEnergyStorage());
    }

    public RouterScreen(RouterMenu menu, Inventory inventory, Component component) {
