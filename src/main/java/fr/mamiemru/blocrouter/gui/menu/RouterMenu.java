...
public class RouterMenu extends EnergyAbstractAbstractContainerMenu {
    ...
    public RouterMenu(int id, Inventory inv, BaseEntityWithMenuProvider entity, ContainerData data) {
