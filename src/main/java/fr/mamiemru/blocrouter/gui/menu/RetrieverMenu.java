...
public class RetrieverMenu extends EnergyAbstractAbstractContainerMenu {
    ...
    public RetrieverMenu(int id, Inventory inv, BaseEntityWithMenuProvider entity, ContainerData data) {
